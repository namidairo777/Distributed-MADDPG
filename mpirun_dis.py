...
if __name__ == '__main__':
    ...
    parser.add_argument('--summary-dir', help='directory for storing tensorboard info', default='./results/2vs1_prioritizedBatch/tfdata/')
    parser.add_argument('--modelFolder', help='the folder which saved model data', default="./results/2vs1_prioritizedBatch/weights/")
